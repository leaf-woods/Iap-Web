...
int main(int argc, char* argv[]) {
    ...
    string fname = "IMG_4585_S_CR_R1.JPG"; // Open IMG_4585_S_CR_R1_SMALL.JPG with ImageMagick. Result is same. 
     ...
     */
    const int lower_h = 100;
    const int lower_s = 158; //150;
    const int lower_v = 0;

    const int upper_h = 120; //140;
    const int upper_s = 255;
    const int upper_v = 155; //255;
    ...
    iap_context* ctx = new iap_context();

    imagecolordesc* desc = ctx->desc;
