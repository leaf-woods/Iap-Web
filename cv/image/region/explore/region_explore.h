...
class region_explore {
    ...
    private:
        ...
        int get_top_sub(const cv::Mat& mat, int c, int r);
        int get_bottom_sub(const cv::Mat& mat, int c, int r);
        int get_left_sub(const cv::Mat& mat, int c, int r);
        int get_right_sub(const cv::Mat& mat, int c, int r);
